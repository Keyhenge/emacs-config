...
*** TODO things to do
openwith dependencies
make sure to use all-the-icons-install-fonts
ag
avfs
*** Keybindings
...
#+END_SRC
Alternatively if you like your current setup, find a place to bind hyper.
*** EXWM
...
** TODO Media
EMMS hasn't been working out for me so I've taken to using Mingus instead. Generally it works out fine, though I'm still on the lookout for something with a better browser and a tag editor, similar to ncmpcpp so that I can completely replace it.
*** EMMS
