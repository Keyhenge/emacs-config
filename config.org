...
** TODO File manager
*** Dired subtrees
Lets you open subdirectories in a dired buffer with =tab=. Cycle depth with =shift tab=.
#+BEGIN_SRC emacs-lisp
  (use-package dired
    :ensure nil
    :delight "Dired "
...
#+BEGIN_SRC emacs-lisp
    (use-package openwith
      :ensure t
      :config
      (add-to-list  'mm-inhibit-file-name-handlers 'openwith-file-handler) ;; Stops open-with from messing with outbound email
